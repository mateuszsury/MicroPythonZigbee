"""HIL smoke for minimal On/Off light endpoint path."""
...
stats = z.event_stats()
print("uzigbee.hil.onoff.stats", stats)
print("uzigbee.hil.onoff.events", len(events))
assert stats["dropped_queue_full"] == 0
assert stats["dropped_schedule_fail"] == 0
assert stats["dispatched"] > 0
if not events:
    print("uzigbee.hil.onoff.note callback_count_zero_but_dispatched_positive")
print("uzigbee.hil.onoff.result PASS")
