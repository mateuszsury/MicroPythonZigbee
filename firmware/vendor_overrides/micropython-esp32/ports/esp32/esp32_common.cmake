...
if(CONFIG_ZB_ENABLED AND CONFIG_ZB_ZCZR AND CONFIG_ZB_GP_ENABLED)
    # Work around static library order: ZBOSS GP code references this symbol
    # from esp-zigbee API archive, so force the linker to pull it in.
    target_link_options(${MICROPY_TARGET} PUBLIC
        -Wl,--undefined=zb_zcl_green_power_cluster_handler
    )
endif()
